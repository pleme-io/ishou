  ...
  internal = rec {
    ...
    crates = {
      ...
      "ishou-cli" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/ishou-cli; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
      ...
      "ishou-render" = rec {
        crateName = "ishou-render";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/ishou-render; };
        libName = "ishou_render";
        dependencies = [
          {
            name = "ishou-tokens";
            packageId = "ishou-tokens";
      ...
      "ishou-tokens" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/ishou-tokens; };
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "Element" "EventTarget" "HtmlCanvasElement" "HtmlElement" "HtmlImageElement" "HtmlMediaElement" "HtmlVideoElement" "ImageBitmap" "ImageData" "Node" "OffscreenCanvas" "VideoFrame" "std" ];
      };
      "wgpu-types" = rec {
